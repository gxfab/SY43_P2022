...
public class EditRevenusActivity extends AppCompatActivity {
    ...
    public void changeRevenus(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        LayoutInflater inflater = this.getLayoutInflater();

        builder.setView(inflater.inflate(R.layout.dialog_edit_revenus, null))
                // Add action buttons
