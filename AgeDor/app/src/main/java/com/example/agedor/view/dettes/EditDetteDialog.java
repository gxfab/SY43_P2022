...
public class EditDetteDialog extends AppCompatDialogFragment {

    private StorageDettes valeursInitiale;
    ...
    private EditDetteDialog.DialogListener listener;

    EditDetteDialog(StorageDettes dette){
        this.valeursInitiale = dette;
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setTitle("Modifier la dette");
