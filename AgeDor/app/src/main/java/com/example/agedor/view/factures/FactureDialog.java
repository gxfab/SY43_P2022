...
public class FactureDialog extends AppCompatDialogFragment {

    private StorageFactures valeursInitiale;
    ...
    private FactureDialog.DialogListener listener;

    FactureDialog(StorageFactures facture){
        this.valeursInitiale = facture;
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setTitle("Modifier la facture");
