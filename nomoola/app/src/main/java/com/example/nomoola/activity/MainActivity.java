...
/***
 * This is the main activity which handle the fragments navigation.
 */
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(R.id.homePage, R.id.inOutComePage, R.id.profilePage).build();
